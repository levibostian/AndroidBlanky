...
class TextChangedEditText : AppCompatEditText {
     ...
     */
    @Deprecated(message = "Use textIfValid to be safe.", replaceWith = ReplaceWith("textIfValid", "com.app.view.widget.TextChangedEditText"), level = DeprecationLevel.ERROR)
