...
public class DateUtil {
    ...
    public static String getHumanReadableMonthsDaysRemaining(Date futureDate) {
        ...
        if (v.months > 0) {
            if (v.months == 1) {
                formattedOutput = formattedOutput.concat(v.months + " month");
            } else {
                formattedOutput = formattedOutput.concat(v.months + " months");
            }
        }
        ...
        if (v.weeks > 0) {
            ...
            if (v.weeks == 1) {
                formattedOutput = formattedOutput.concat(v.weeks + " week");
            } else {
                formattedOutput = formattedOutput.concat(v.weeks + " weeks");
            }
        }
        ...
        if (v.days > 0) {
            ...
            if (v.days == 1) {
                formattedOutput = formattedOutput.concat(v.days + " day");
            } else {
                formattedOutput = formattedOutput.concat(v.days + " days");
            }
        }
