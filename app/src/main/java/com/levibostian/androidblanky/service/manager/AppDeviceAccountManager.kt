...
class AppDeviceAccountManager(private val accountManager: AccountManager): DeviceAccountManager {
    ...
    override fun continueLoginFlow(activity: Activity, forceLogout: Boolean, passwordlessToken: String?, done: (success: Boolean) -> Unit) {
    ...
    override fun login(email: String, accessToken: String) {
